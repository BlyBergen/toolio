...
class RatingsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'listing_id' => ['type' => 'integer', 'length' => 25, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
        ...
        '_constraints' => [
            ...
            'lst_fid' => ['type' => 'foreign', 'columns' => ['listing_id'], 'references' => ['listings', 'id'], 'update' => 'cascade', 'delete' => 'noAction', 'length' => []],
            'user_fid' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'cascade', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
